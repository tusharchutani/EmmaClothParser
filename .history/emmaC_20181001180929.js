...
async function getProductInfo(productUrl){
	...
	//option 1
	debugger
	$('.good_size > div.good_size_row > div.good_size_cell',html).each(function(item,i){
		debugger
	});
	console.log("Option 1 - sizes ");
	//option 2
}
...
(async function(){
	...
	await getProductInfo("https://www.emmacloth.com/Cut-Out-Detail-Glitter-Dress-p-419152-cat-1727.html");
