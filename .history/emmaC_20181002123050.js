...
async function getProductInfo(productUrl){
	...
	var productHandel, productTitle, body, option1Name, option1Value, option2Name, option2Value, variantSKU, variantInventorySKU,variantPrice, imgSrc, imgPos, imgAlt, migratedFrom;
	var productType = [];
	var productTags = [];
	var imgSrc = [];
	productHandel = $("#productCodeSpan",html).text();
	productTitle = $('body > div.indexHomeBody > div.main_content > div > div.goods_desc > div.detail > div > div.good_descright > h1',html).text();
	debugger
