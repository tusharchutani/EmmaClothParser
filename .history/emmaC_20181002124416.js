...
async function getProductInfo(productUrl){
	...
	var productHandel, productTitle,variantPrice, body, productType, option1Name, option2Name, option2Value, variantSKU, variantInventorySKU, imgSrc, imgPos, imgAlt, migratedFrom;
	var productTags,option1Values, imgSrc = [];
