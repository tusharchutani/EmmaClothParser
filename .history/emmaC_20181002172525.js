...
async function getProductInfo(productUrl, otherOptionsVetted=false){
	log.info("Getting product info by url:"+productUrl + "Other options vetted "+otherOptionsVetted);
...
(async function(){
	...
	await getProductInfo("https://www.emmacloth.com/Red-Batwing-Long-Sleeve-Loose-Knit-Sweater-p-195373-cat-1734.html");
