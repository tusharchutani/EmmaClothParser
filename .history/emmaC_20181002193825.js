...
async function getAllProductsFromHeaderLink(headerLink){
	...
	$('#productsContent1_goods > div.goods_mz > a',html).each(async function(i,item){
		debugger
		var x = $(this);
		log.info(x.text());
...
(async function(){
	...
	await getAllProductsFromHeaderLink("https://www.emmacloth.com/daily/2018-09-29/new_arrival/?icn=what%27snew&ici=ec_navbar01menu03dir01");
