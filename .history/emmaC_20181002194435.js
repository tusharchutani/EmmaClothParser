...
async function getAllProductsFromHeaderLink(headerLink){
	...
	$('#productsContent1_goods > div > div.goods_mz > a',html).each(async function(i,item){
		...
		log.info("Getting product info of product found on page "+headerLink);
...
(async function(){
	...
	await getAllProductsFromHeaderLink("https://www.emmacloth.com/daily/2018-09-29/new_arrival/?icn=what'snew&ici=ec_navbar01menu03dir01 ");
